...
<div class="my-8">
  <img src="/images/sma_pan_encuesta_updated.png" alt="Gráfica Encuesta PAN San Miguel de Allende 2027 - Juan Pasqualli" class="w-full h-auto rounded-lg shadow-md border border-hairline" />
</div>
...
const updatedExcerpt = "Una nueva encuesta ubica a Juan Pasqualli Rodríguez como el favorito con el 31.4% de las preferencias para la candidatura del PAN a la alcaldía de San Miguel de Allende en 2027.";

async function main() {
  console.log("Updating Pasqualli article in Supabase with new chart & percentages...");
  ...
  if (error) {
    ...
    console.log("Successfully updated Pasqualli article!");
    console.log("Title:", data[0]?.title);
    console.log("New Chart Image Link: /images/sma_pan_encuesta_updated.png");
  }
}
