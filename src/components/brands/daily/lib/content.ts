...
export const trending: { title: L; slug?: string }[] = [
  { title: { es: "Qué cambia con el nuevo reglamento de rentas en el Centro Histórico", en: "What changes under the new rental rules in the historic center" }, slug: "nuevo-reglamento-rentas-centro-historico" },
  { title: { es: "El agua de San Miguel: cinco gráficas sobre la presa Allende", en: "San Miguel's water: five charts on the Allende reservoir" }, slug: "presa-allende-sequia-2024" },
  { title: { es: "Guía: doce restaurantes nuevos en la ciudad este verano", en: "Guide: twelve new restaurants in the city this summer" }, slug: "restaurantes-verano-2026" },
  { title: { es: "Quién financia las campañas municipales de 2027", en: "Who is funding the 2027 municipal campaigns" }, slug: "financiacion-campanas-2027" },
  { title: { es: "El peso, el nearshoring y las casas de dos millones de dólares", en: "The peso, nearshoring and the two-million-dollar houses" }, slug: "nearshoring-casas-2-millones" },
];

export const latest: { time: string; title: L; slug: string; category: string; image: string }[] = [
  { time: "07:30", title: { es: "Inician los preparativos finales para el FASMA 2026 este viernes", en: "Final preparations for FASMA 2026 begin this Friday" }, slug: "preparativos-fasma-2026", category: "Cultura", image: "/images/sma_fasma.jpg" },
  { time: "08:45", title: { es: "Benny Ibarra visita San Miguel de Allende y anuncia gira", en: "Benny Ibarra visits San Miguel de Allende and announces tour" }, slug: "benny-ibarra-visita-san-miguel", category: "Cultura", image: "/images/sma_concert.jpg" },
  { time: "10:15", title: { es: "Confirman hallazgo de ciudadano extranjero en Boca de la Cañada", en: "Discovery of foreign citizen confirmed in Boca de la Cañada" }, slug: "hallazgo-ciudadano-extranjero-boca-canada", category: "San Miguel", image: "/images/sma_rescue.jpg" },
  { time: "11:30", title: { es: "Recuperan dos cuerpos en la presa de Jalpa tras operativo de búsqueda", en: "Two bodies recovered at Jalpa reservoir after search operation" }, slug: "recuperan-cuerpos-presa-jalpa", category: "San Miguel", image: "/images/sma_presa.jpg" },
  { time: "12:45", title: { es: "Éxito total en torneo nacional de taekwondo; asisten mil competidores", en: "Total success at national taekwondo tournament; 1,000 competitors attend" }, slug: "exito-torneo-nacional-taekwondo", category: "Deportes", image: "/images/sma_taekwondo.jpg" },
];
...
export const events: { day: string; month: L; title: L; place: string }[] = [
  { day: "15", month: { es: "Ago", en: "Aug" }, title: { es: "FASMA: Festival de las Artes", en: "FASMA: Arts Festival" }, place: "Múltiples Sedes · Todo el día" },
  { day: "27", month: { es: "Ago", en: "Aug" }, title: { es: "Festival San Miguel y sus Sabores", en: "San Miguel and its Flavors" }, place: "Parque Juárez · 13:00" },
  { day: "19", month: { es: "Sep", en: "Sep" }, title: { es: "Feria de San Miguel de Allende", en: "San Miguel de Allende Fair" }, place: "Recinto Ferial · 17:00" },
];
